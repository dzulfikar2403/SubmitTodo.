...
import { handleDeleteTodo, handleUpdateTodoStatus } from "@/lib/todo/actionTodo";
...
const TaskItem = ({ title, data, staticUI }: TaskItemProps) => {
  ...
  return (
    <div className="my-2">
      ...
      >
        ...
        {data?.map((el) => (
          <div key={el.id} className="relative flex items-center justify-between">
