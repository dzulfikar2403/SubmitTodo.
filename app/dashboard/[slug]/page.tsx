...
import { getAllTodoByType, getAllTrashTodo } from '@/lib/query';
    ...
    <DashboardLayout>
      <main className='w-full p-10'>
        ...
        <div>
          ...
          <TaskItem title={pathName} staticUI data={getDataByType?.rows as any[]} trashLength={dataTrash?.rowCount as number ?? 0} />
        </div>
      </main>
    </DashboardLayout>
  )
